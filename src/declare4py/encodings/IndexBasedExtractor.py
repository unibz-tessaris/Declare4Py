...
class IndexBasedExtractor(TransformerMixin):
    ...
    def __init__(self, cat_cols, num_cols, max_events, fillna=True):
        ...
        self.num_cols = num_cols        # numerical columns
        self.max_events = max_events    # maximum prefix length
        self.fillna = fillna            # TRUE: replace NA to 0 value in dataframe / FALSE: keep NA
        self.columns = None
